...
export default function ProducerReturn() {
  ...
  const submit = async (e) => {
    ...
    try {
      await api.post("/transfers/producer-return", { producerId, toStoreId, materials: toReturn });
  ...
  return (
    <div className="page">
      <h2>Producer Return</h2>
      <div className="form-block">
        <h3>Return Raw Materials from Producer to Store</h3>
